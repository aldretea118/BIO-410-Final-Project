...
## Background
This data consist of 6 samples from the organism _____. This organism is a _____ which ______ [citation].

## Purpose
The purpose of this project was to create a phylogenic tree from 6 samples of _____ in order to determine the evolutionary relationships between the samples. 
